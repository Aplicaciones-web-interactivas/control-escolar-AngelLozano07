...
<body
    ...
    <div class="w-1/2 borber border-gray-300 rounded-md p-6 bg-gray-100 shadow-md">
        <form method="post" action="{{ route('grupo.agregar') }}">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="text"
                    ...
                    name="nombre" id="" aria-describedby="helpId" placeholder="Nombre del grupo" />
            </div>
            <div class="mb-3">
                    ...
                    <tr>
                        ...
                        <td class="text-center gap-4">
                            ...
                            <button
                                ...
                                <a href="{{ route('grupo.mostrar', $grupo->id) }}">
                            ...
                            <form method='post' action='{{ route('grupo.eliminar', $grupo->id) }}'>
